-- ==========================================
-- FIX NOTIFICATIONS (V2 - SAFE UPDATE)
-- ==========================================

-- 1. Cleaning up any incompatible data first
-- This ensures the new constraint won't fail
UPDATE notifications 
SET type = 'message' 
WHERE type NOT IN ('like', 'comment', 'tag', 'capsule', 'letter', 'message', 'broadcast', 'system');
...
-- 5. Create Trigger Function to Fan-Out Notifications
...
-- 6. Attach Trigger to Admin Broadcasts
...
-- 7. RLS Policies for Admin Broadcasts
ALTER TABLE admin_broadcasts ENABLE ROW LEVEL SECURITY;

-- Drop existing policies if they exist to avoid errors
DROP POLICY IF EXISTS "Admins can create broadcasts" ON admin_broadcasts;
DROP POLICY IF EXISTS "Admins can view broadcasts" ON admin_broadcasts;
